...
export default {
    ...
    gdAjax(obj){
        ...
        return new Promise((resolve,reject)=>{
            ...
            if(obj.methodType=="GET" || obj.methodType=="DELETE"){
                param = obj.param;
            }else if(obj.methodType == "POST" || obj.methodType == "PUT" || obj.methodType == "PATCH"){
                param = obj.param;
            }
            if(obj.headers){
            ...
            if(obj.methodType=='JSONP'){
                ...
                if(obj.url.indexOf('?token=')==-1 && (obj.url.indexOf('/lachesis/api/')>-1 || obj.url.indexOf('/redang/api/')>-1 || obj.url.indexOf('/skr/api/')>-1  || obj.url.indexOf('/integral/api/')>-1) ){
